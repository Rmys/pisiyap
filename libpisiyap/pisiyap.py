...
from .gui.pisiyapui import Pisiyap
...
class PisiYap(QMainWindow):
    ...
    def mkdir(self, directory):
        try:
            ...
            QMessageBox.warning(self, self.tr("PiSiYap Warning"), self.tr("You must specify a directory to continue."))
    ...
    def selectDir(self):
        directory = QFileDialog.getExistingDirectory(self, self.tr("Choose a directory to store PiSi packages"))
    ...
    def brwSource(self):
        sourceFile = QFileDialog.getOpenFileName(self, self.tr("Select source file"), '', '', None)
        self.ui.brwsLine_.setText(sourceFile[0])
        self.copyArchive()
    ...
    def homePage(self):
        ...
        if homePage:
            ...
            return [False, self.tr('Home Page')]
    ...
    def archiveAddr(self):
        ...
        if archiveAddr:
            ...
            return [False, self.tr('Archive Address')]
    ...
    def pkgVersion(self):
        ...
        if pkgVersion and not newPkgVersion:
            ...
            return [False, self.tr('Package Version')]
    ...
    def fileName(self):
        ...
        if fileName:
            ...
            return [False, self.tr('Archive File')]
    ...
    def packageName(self):
        if self.fileName()[0]:
            ...
            packageName = [False, self.tr('Package Name')]
    ...
    def packagerName(self):
        ...
        if packagerName:
            ...
            return [False, self.tr('Packager Name')]
    ...
    def packagerEmail(self):
        ...
        if packagerEmail:
            ...
            return [False, self.tr('Packager E-mail')]
    ...
    def description(self):
        ...
        if description:
            ...
            return [False, self.tr('Description')]
    ...
    def createFiles(self):
        ...
        if self.checkFields():
            ...
            elif self.ui.kde5Tools.isChecked():
                actionspy = actions.kde5Tools
            elif self.ui.qt5Tools.isChecked():
                actionspy = actions.qt5Tools
